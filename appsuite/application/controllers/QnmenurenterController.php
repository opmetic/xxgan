...
class QnmenurenterController extends Zend_Controller_Action_Qn
{    
    ...
    public function addAction()
    {
    	...
    	$view->display('renter/menuadd.tpl');
    }
	...
	public function adddoAction()
    {
		...
		if ($menuname && $menucode)
		{
			$in_ary = array(
				...
				$db->insert($config['factory_enterprisecode'] . '_' . TABLE_QNSOFT_MENU, $in_ary);
		}
        $this->msg("新增目录成功", "/qnmenurenter/add");
	...
	public function listAction()
	{
        ...
        $select = $db->select();
        $select->from($config['factory_enterprisecode'] . '_' . TABLE_QNSOFT_MENU . ' as m', '*');
    	...
    	$view->display('renter/menulist.tpl');
	}
	...
	public function editAction()
	{
		...
		if (!$submit)
		{
			...
			//父目录目录信息
			$select = $db->select();
			$select->from($config['factory_enterprisecode'] . '_' . TABLE_QNSOFT_MENU, '*');
			...
			$view->display('renter/menuedit.tpl');
		}
		else
		{
			$menuname = $this->_getParam('menuname');
            ...
            {
                $urlArray = array(
                    array('title' => "返回列表", 'url' => "/qnmenurenter/list")
                );
			...
			$db->update($config['factory_enterprisecode'] . '_' . TABLE_QNSOFT_MENU, $up_ary, $where);

			header('location: ' . $config['site_url'] . '/qnmenurenter/list');
		}
	}
	...
	public function delAction()
	{
		...
		if ($Data)
		{
			...
			echo "<a href=\"" . $config['site_url'] . '/qnmenurenter/list">返回</a>';
		}
		else
		{
			$up_ary = array(
