...
class ScriptrenterController extends Zend_Controller_Action_Qn
{    
	...
	public function listAction()
	{
		...
		if ($submit && $userid)
		{
			...
			$select->join($config['factory_enterprisecode'] . '_' . TABLE_QNSOFT_USER . ' as u', 'u.uid = s.user_id', 'nickname');//多表联合查询
    	...
    	$view->display('renter/scriptlist.tpl');
	}
	...
	public function addAction()
	{
		...
		$view->display('renter/scriptadd.tpl');
	}
	...
	public function editAction()
	{
		...
		if ($submit && $id)
		{
			...
			$db->update($config['factory_enterprisecode'] . '_' . TABLE_QNSOFT_SCRIPTDB, $in_ary, $where);


			header('location: ' . $config['site_url'] . '/scriptrenter/list');
		}
		else
		{
			$select = $db->select();
			...
			$view->display('renter/scriptedit.tpl');
		}
	}
	...
	public function delAction()
	{
		...
		if ($id)
		{
			...
			$db->update($config['factory_enterprisecode'] . '_' . TABLE_QNSOFT_SCRIPTDB, $up_ary, $where);
    ...
    public function indexAction()
    {
		...
		$view->assign('script', $script);
		$view->display('renter/scriptmamage.tpl');
    }
