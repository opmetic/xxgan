...
<link type="text/css" href="{$system_config.img_url}/appsuite_images/appsuite.css" rel="stylesheet"/>
<script type="text/javascript" src="{$system_config.img_url}/appsuite_script/appsuite.js"></script>
<script type="text/javascript" src="{$system_config.img_url}/appsuite_script/appsuiteDB.js"></script>
	 
<!-- 下拉菜单 -->
<link rel="stylesheet" href="{$system_config.img_url}/appsuite_images/dd.css" type="text/css" />
<script type="text/javascript" src="{$system_config.img_url}/appsuite_script/jquery.dd.js"></script>
...
登陆IP:{$param.ip}<br/><a href="/access/logout" style="display:;">QUIT</a></span></div>
  </div>
  <!-- head end -->
  ...
  <div class="qn_left">
	    ...
	    <!-- select -->
	  	<div class="qn_use_state">
			<select name="use_state" id="use_state" style="width:200px;">
				<option value="login" title="{$system_config.img_url}/appsuite_images/icons/flag_green.png">登陆</option>
				<option value="logout" selected="selected"  title="{$system_config.img_url}/appsuite_images/icons/flag_red.png">退出</option>
			</select> 
	  ...
	  <div class="left_middle_tools">
	  	...
	  	<div style="height:294px; border:#000000 0px solid; margin: 1px; overflow: auto;">
			<ul id="sortable">
				<li class="tools_hold" id="tools_hold" style="font-size: 14px;"><img src="{$system_config.img_url}/appsuite_images/icon_lockopen.gif" style="display:;" /></li>
				<li class="tools_back" id="tools_back" style="font-size: 14px;"><img src="{$system_config.img_url}/appsuite_images/icon_lockopen.gif" style="display:;" /></li>
				<li class="tool_consult" id="tool_consult" style="font-size: 14px;"><img src="{$system_config.img_url}/appsuite_images/icon_lockopen.gif" style="display:;" /></li>
				<li class="tool_transfer" id="tool_transfer" style="font-size: 14px;"><img src="{$system_config.img_url}/appsuite_images/icon_lockopen.gif" style="display:;" /></li>
				<li class="tools_Conference" id="tool_Conference" style="font-size: 14px;"><img src="{$system_config.img_url}/appsuite_images/icon_lockopen.gif" style="display:;" /></li>
				<li class="tool_addressbook" id="tool_addressbook" style="font-size: 14px;"><img src="{$system_config.img_url}/appsuite_images/icon_lockopen.gif" style="display:;" /></li>
				<li class="ui-state-default" id="tool_monitoring" style="display: none;"><img src="{$system_config.img_url}/appsuite_images/icon_lockopen.gif" style="display:;" /></li>
				<li class="ui-state-default" id="tool_intruding" style="display: none;"><img src="{$system_config.img_url}/appsuite_images/icon_lockopen.gif" style="display:;" /></li>
				<li class="ui-state-default" id="tool_intrudingparty" style="display: none;"><img src="{$system_config.img_url}/appsuite_images/icon_lockopen.gif" style="display:;" /></li>
			</ul>
	  	</div>
