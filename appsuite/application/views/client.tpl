...
<link type="text/css" href="{$system_config.img_url}/client_images/appsuite.css" rel="stylesheet"/>
<script type="text/javascript" src="{$system_config.img_url}/client_script/appsuiteDB.js"></script>
<script type="text/javascript" src="{$system_config.img_url}/client_script/appsuite.js"></script>
...
$(function(){
    $('#leftmenu').tree({
	    checkbox: false,
	    url: '{/literal}{$system_config.site_url}/qnmenu/jsonlist/factoryid/{$user.factory_id}{literal}',
			...
			<div style="border:#000000 0px solid; float:right;width: 400px; height: 55px; ">
				<table>
					...
					<tr height=30>
						...
						<td><a id="sb" {if $user.role > 1 }style="display:none;"{/if} stype="" href="javascript:void(0);" class="easyui-splitbutton" plain="true" menu="#monitorskill">班长功能</a></td>
						<td>
