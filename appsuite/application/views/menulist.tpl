...
{
	parent.updateWindows("编辑 " + title, "{/literal}{$system_config.img_url}{literal}/qnmenu/edit/id/" + id, true);
}
...
function confirmDle(id)
{
	...
	if (bln)
	{
		location.href = "{/literal}{$system_config.img_url}{literal}/qnmenu/del/id/" + id;
	}
}
</script>
{/literal}
