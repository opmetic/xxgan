...
<div style="background:#FFFFFF;padding:10px;">
    <form id="editscript" method="post" action="{$system_config.img_url}/qnphone/edit">
	<input type="hidden" name="id" value="{$phoneData.phone_id}"/>
	<table cellpadding="10" cellspacing="10">
		<tr>
			<td align="right">分机号:</td>
			<td><input class="easyui-validatebox" type="text" name="num" id="num" value="{$phoneData.phone_num}"></input></td>
		...
		<tr>
			...
			<td>
				<select id="factoryid" name="factoryid">
					...
					<option value="{$item.factory_id}" {if $phoneData.factory_id == $item.factory_id}selected{/if}>{$item.factory_name}</option>
					{/foreach}
				</select>
			</td>
			<td></td>
        ...
        <tr>
            ...
            <td><input class="easyui-validatebox" type="text" name="ip" id="ip" value="{$phoneData.machineip}"></input></td>
            <td><span style="color:#FF0000;">*</span></td>
        
        </tr>
        <tr>
            <td align="right">模块号:</td>
            <td><input class="easyui-validatebox" type="text" name="basemodel" id="basemodel" value="{$phoneData.basemodel}"></input></td>
            <td><span style="color:#FF0000;">*</span></td>
