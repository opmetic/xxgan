...
<div style="background:#FFFFFF;padding:10px;">
    <form id="editscript" method="post" action="{$system_config.img_url}/qnbuttonrenter/edit">
    <div style="color: #FF0000;">{$post.errmsg}</div>  
	<table cellpadding="10" cellspacing="10">
		<tr>
			<td align="right" width="100" >按键名:</td>
			<td><input class="easyui-validatebox" type="text" name="button_name" id="button_name" required="true" width="200" value="{$buttonData.button_name}"></input></td>
			<td><span style="color:#FF0000;">*</span></td>
		</tr>
		<tr>
			<td align="right">按键值:</td>
			<td><input class="easyui-validatebox" type="text" id="button_info" name="button_info" value="{$buttonData.button_info}"></input></td>
        ...
        <tr>
            ...
            <td>
                <select name="button_group" id="button_group">
                    <option value="100" {if $buttonData.button_group == 100}selected="selected"{/if}>常用</option>
                    <option value="101" {if $buttonData.button_group == 101}selected="selected"{/if}>非常用</option>
                </select>
            <td><span style="color:#FF0000;">*</span></td>
        </tr>
		<tr>
    ...
    <input type="hidden" name="id" value="{$buttonData.button_id}" />
    </form>
</div>
