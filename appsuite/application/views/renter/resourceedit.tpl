...
<div style="background:#FFFFFF;padding:10px;">
    <form id="editscript" method="post" action="{$system_config.img_url}/qnresourcerenter/edit">
        ...
        <tr>
            ...
            <td>
                <select id="resource_type" name="resource_type">
                    ...
                    <option value="{$key2}" {if $resourceData.resource_type == $key2}selected{/if}>{$item2}</option>
                    {/foreach}
                </select>
            </td>
            <td></td>
