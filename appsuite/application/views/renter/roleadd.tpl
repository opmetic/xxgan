...
<div style="background:#FFFFFF;padding:10px;">
    <form id="editscript" method="post" action="{$system_config.img_url}/qnrolerenter/adddo">
	...
	<table cellpadding="10" cellspacing="10">
        ...
        <tr>
            ...
            <td><input type="text" name="dsc" id="dsc" required="true" width="500" value="{$post.name}"></input></td>
            <td></td>
        </tr>
		<tr>
			<td align="right"> </td>
