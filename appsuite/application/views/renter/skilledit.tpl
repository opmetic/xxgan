...
<div style="background:#FFFFFF;padding:10px;">
    <form id="editscript" method="post" action="{$system_config.img_url}/qnskillrenter/edit">
	...
	<table cellpadding="10" cellspacing="10">
        ...
        <tr>
            ...
            <td><input class="easyui-validatebox" type="text" id="fakecalling" name="fakecalling" value="{$skillData.fakecalling}"></input></td>
            <td><span style="color:#FF0000;">*</span></td>
        </tr>
		<tr>
			<td align="right"> </td>
