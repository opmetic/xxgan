...
{
	parent.updateWindows("编辑 " + title, "{/literal}{$system_config.img_url}{literal}/qnskillrenter/edit/id/" + id, true);
}
...
function confirmDle(id)
{
	...
	if (bln)
	{
		location.href = "{/literal}{$system_config.img_url}{literal}/qnskillrenter/del/id/" + id;
	}
}
</script>
{/literal}
...
<table id="listtab" fit="true">
	<thead>
		<tr>
            ...
            <th field="f4" width="160">外呼显示号</th> 
