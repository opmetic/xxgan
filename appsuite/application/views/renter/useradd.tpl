...
<div style="background:#FFFFFF;padding:10px;">
    <form id="editscript" method="post" action="{$system_config.img_url}/qnuserrenter/adddo">
	...
	<table cellpadding="10" cellspacing="10">
        ...
        <tr>
            ...
            <td><input class="easyui-validatebox" type="text" id="pwdplaintext" name="pwdplaintext" value="123456"></input></td>
            <td><span style="color:#FF0000;">*</span></td>
        </tr>
        <tr>
		...
		<tr>
			...
			<td><input class="easyui-validatebox" type="text" id="plain_pwd" name="plain_pwd" value="123456"></input></td>
			<td><span style="color:#FF0000;">*</span></td>
		</tr>
		<tr>
			...
			<td id="skills">
                ...
                <input type="checkbox" name="skillarray[]" value="{$item.skill_id}"/>{$item.skill_name}<br/>
                {/foreach} 
            </td>
			<td></td>
		</tr>
