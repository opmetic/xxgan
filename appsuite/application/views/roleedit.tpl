...
<div style="background:#FFFFFF;padding:10px;">
    <form id="editscript" method="post" action="{$system_config.img_url}/qnrole/edit">
		...
		<tr>
            ...
            <td>
                <select id="factoryid" name="factoryid">
                    ...
                    <option value="{$item.factory_id}" {if $roleData.factory_id == $item.factory_id}selected{/if}>{$item.factory_name}</option>
                    {/foreach}
                </select>
            </td>
            <td></td>
