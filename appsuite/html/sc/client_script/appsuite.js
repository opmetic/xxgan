...
//    $("*").contextmenu(option);
	...
	*/
    ...
    $("#cti_tool_pay_manual").click(function(){ //转人工支付
        try
        {
            //AppSuiteObject("command", "singlesteptransfer", "02155304973");
    ...
    $("#cti_tool_internation_cq").click(function(){ //转国际机票 重庆 02155304965
        try
        {
            AppSuiteObject("command", "singlesteptransfer", "02155304965");
        }
        catch(err)
        {
            alert(err.description);
    ...
    $("#cti_tool_internation_hn").click(function(){ //转国际机票 湖南 02155304968
        try
        {
            AppSuiteObject("command", "singlesteptransfer", "02155304968");
        }
        catch(err)
        {
            alert(err.description);
    ...
    $("#cti_tool_internation_sc").click(function(){ //转国际机票 四川 02155304902
        try
        {
            AppSuiteObject("command", "singlesteptransfer", "02155304902");
        }
        catch(err)
        {
            alert(err.description);
