<?php /* Smarty version 2.6.20, created on 2011-05-30 21:43:01
         compiled from renter/buttonedit.tpl */ ?>
...
/qnbuttonrenter/edit">
	...
	<table cellpadding="10" cellspacing="10">
		<tr>
			...
			<td><input class="easyui-validatebox" type="text" name="button_name" id="button_name" required="true" width="200" value="<?php echo $this->_tpl_vars['buttonData']['button_name']; ?>
"></input></td>
			<td><span style="color:#FF0000;">*</span></td>
		</tr>
		<tr>
			<td align="right">按键值:</td>
			<td><input class="easyui-validatebox" type="text" id="button_info" name="button_info" value="<?php echo $this->_tpl_vars['buttonData']['button_info']; ?>
"></input></td>
        ...
        <tr>
            ...
            <td>
                <select name="button_group" id="button_group">
                    <option value="100" <?php if ($this->_tpl_vars['buttonData']['button_group'] == 100): ?>selected="selected"<?php endif; ?>>常用</option>
                    <option value="101" <?php if ($this->_tpl_vars['buttonData']['button_group'] == 101): ?>selected="selected"<?php endif; ?>>非常用</option>
                </select>
            <td><span style="color:#FF0000;">*</span></td>
        </tr>
		<tr>
    ...
    <input type="hidden" name="id" value="<?php echo $this->_tpl_vars['buttonData']['button_id']; ?>
" />
    </form>
</div>
