<?php /* Smarty version 2.6.20, created on 2012-03-14 13:17:05
         compiled from cs/client.tpl */ ?>
...
"><?php echo $this->_tpl_vars['item']['button_name']; ?>
      ...
      <?php if ($this->_tpl_vars['userdefButton101']): ?>
      <div>   
      <span>全部</span>
...
<?php $_from = $this->_tpl_vars['agentList']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['item']):
?>
    var str = csAgentClient.manageData('<?php echo '<?xml'; ?>
 version="1.0" <?php echo '?>'; ?>
<cmdbody><cmdtype>local</cmdtype><cmdname>setparam</cmdname><parameter><element name="BP<?php echo $this->_tpl_vars['item']['workid']; ?>
" type="" value="<?php echo $this->_tpl_vars['item']['plain']; ?>
" /><element name="PB<?php echo $this->_tpl_vars['item']['plain']; ?>
" type="" value="<?php echo $this->_tpl_vars['item']['workid']; ?>
" /></parameter></cmdbody>');
<?php endforeach; endif; unset($_from); ?>
