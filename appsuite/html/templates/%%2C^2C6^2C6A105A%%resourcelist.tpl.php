<?php /* Smarty version 2.6.20, created on 2011-04-14 11:53:30
         compiled from resourcelist.tpl */ ?>
...
<?php echo '/qnresource/list/sourcetype/" + $("#resource_type").val();
}
...
<?php echo $this->_tpl_vars['system_config']['img_url']; ?>
<?php echo '/qnresource/show/id/" + id, true);
}
...
<?php echo $this->_tpl_vars['system_config']['img_url']; ?>
<?php echo '/qnresource/edit/id/" + id, true);
}
