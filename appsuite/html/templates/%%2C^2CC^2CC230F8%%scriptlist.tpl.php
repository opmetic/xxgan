<?php /* Smarty version 2.6.20, created on 2011-04-13 01:14:59
         compiled from scriptlist.tpl */ ?>
...
<?php echo $this->_tpl_vars['system_config']['site_url']; ?>
<?php echo '/script/add/id/" + id, true);
}
...
<?php echo $this->_tpl_vars['system_config']['site_url']; ?>
<?php echo '/script/edit/id/" + id, true);
}
