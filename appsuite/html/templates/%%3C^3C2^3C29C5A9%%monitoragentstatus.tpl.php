<?php /* Smarty version 2.6.20, created on 2011-08-02 22:05:54
         compiled from monitoragentstatus.tpl */ ?>
...
<table width="870"  valign="top" border="0" cellpadding="0" cellspacing="1" >
  <tr >
  <td   height=30 width="690" background="<?php echo $this->_tpl_vars['system_config']['img_url']; ?>
/monitor/images/title.jpg">
   &nbsp;&nbsp;&nbsp;<img src="<?php echo $this->_tpl_vars['system_config']['img_url']; ?>
/monitor/images/select1.jpg" width="16" border=0 height="16" />&nbsp;&nbsp;<font style="font-size:16px; font-family:'宋体';color=white"><b> 坐席状态监控</b></font>
             ...
             <table width="860" border=0 align="left" cellpadding="1" cellspacing="0">
              <tr>
                <td bgcolor="blue">
                  ...
                  <tr  >
                    <td width="" align="left" background="<?php echo $this->_tpl_vars['system_config']['img_url']; ?>
                                                              ...
                                                              <tr>
                                                                    ...
                                                                    <td  valign="bottom" align="left" > 
                                                                        ...
                                                                        <table border=0 cellpadding="0" >
                                                                                <tr> 
                                                                                             <td  valign="bottom" align="left" > 
                                                                                              <iframe width="860"    height="42"  style="display:'';" marginWidth=0 marginHeight=0   bordercolor="#009900"  name="HeadAgentStatus" id="HeadAgentStatus" src="<?php echo $this->_tpl_vars['system_config']['img_url']; ?>
/monitor/agentstatushead" frameborder=0></iframe>
                                                                    
                                                                                              </td>  
                                                                                </tr>
                                                                                <tr> 
                                                                                             <td  valign="bottom" align="left" > 
                                                                                              <iframe width="860"    height="496"  style="display:'';" marginWidth=0 marginHeight=0   bordercolor="#009900"  name="AgentStatus" id="AgentStatus" src="<?php echo $this->_tpl_vars['system_config']['img_url']; ?>
/monitor/agentstatustable" frameborder=0></iframe>
...
<?php echo '   
 <SCRIPT LANGUAGE=javascript>
  ...
  '; ?>
	...
	var namesjson = <?php echo $this->_tpl_vars['namesjson']; ?>
;
