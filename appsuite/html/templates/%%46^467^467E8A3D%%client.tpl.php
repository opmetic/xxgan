<?php /* Smarty version 2.6.20, created on 2011-03-08 03:37:29
         compiled from channelsoft/client.tpl */ ?>
        ...
        <div style="height: 60px; border:#f00 0px solid;">
            <ul id="toolbar">
                ...
                <li style="width: 100px;">
                    ...
                    <input type="checkbox" id="AutoAnswer"<?php if ($this->_tpl_vars['user']['autoanswer'] == 1): ?>checked="checked"<?php endif; ?>>自动应答  <p/>
                </li>
                <li> 
                    <a stype="" href="javascript:void(0);" class="easyui-splitbutton" plain="true" menu="#otherskill">休息</a>
                </li>
            </ul>
        </div>
        <div>
            ...
            <div style="width: 600px; float:left;margin-top:7px;">  
                ...
                <span >来自:浙江 杭州<span id="msg_callid"></span></span>
            </div>
        </div>
	</div> <!-- 顶部 end -->
