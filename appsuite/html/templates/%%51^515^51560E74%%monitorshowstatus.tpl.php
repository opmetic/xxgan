<?php /* Smarty version 2.6.20, created on 2011-05-13 20:37:59
         compiled from monitorshowstatus.tpl */ ?>
...
'; ?>
 ...
 <br>
  <body leftMargin=20  topMargin=0 background="<?php echo $this->_tpl_vars['system_config']['img_url']; ?>
...
<tr>
<td bgcolor="#E0EDF6" background="<?php echo $this->_tpl_vars['system_config']['img_url']; ?>
/monitor/images/bodybg.gif"> 
<table width="860"  valign="top" border="0" cellpadding="0" cellspacing="1" >
  <tr >
  <td   height=30 width="560" background="<?php echo $this->_tpl_vars['system_config']['img_url']; ?>
/monitor/images/title.jpg">
   &nbsp;&nbsp;&nbsp;<img src="<?php echo $this->_tpl_vars['system_config']['img_url']; ?>
/monitor/images/select1.jpg" width="16" border=0 height="16" />&nbsp;&nbsp;<font style="font-size:16px; font-family:'宋体';color=white"><b> 系统实时监控</b></font>
 
  
  </td>    
  <td   height=30 align="left" width="300" background="<?php echo $this->_tpl_vars['system_config']['img_url']; ?>
/monitor/images/title.jpg">&nbsp;技能组：
                         <select  name="Skills"  onChange="groupChange(this.value)" style="HEIGHT: 25px;">
                                    <?php if ($this->_tpl_vars['flag'] == 'gz'): ?>
   ...
   <td   height=30 align="center" width="100" background="<?php echo $this->_tpl_vars['system_config']['img_url']; ?>
/monitor/images/title.jpg"> 
                            <img name="Start" onclick="initial()" src="<?php echo $this->_tpl_vars['system_config']['img_url']; ?>
/monitor/images/Start.png" width="73" height="19" border="0" alt="" />
     </td>    
</tr>
      <tr>
             ...
             <table width="800" border=0 align="center" cellpadding="1" cellspacing="0">
              <tr>
                <td bgcolor="blue">
                  ...
                  <tr height=380>
                    <td width="" align="center" background="<?php echo $this->_tpl_vars['system_config']['img_url']; ?>
/monitor/images/bodybg.jpg" >
                                                ...
                                                <table border=0 cellpadding="0"  >
                                                    <tr>
                                                                 ...
                                                                 <td align="center" width="36">
                                                                          <table border=0 cellpadding="0"  >    
                                                                                         <tr><td height=20 align="center" width=36 valign="bottom"><div id="DivTotalAgentNum">0</div></td></tr><td valign="bottom" id="TotalAgentNumH"  height="1" background="<?php echo $this->_tpl_vars['system_config']['img_url']; ?>
/monitor/images/BG1.gif"></td></tr>
                                                                                 </table>
                                            ...
                                            <td  valign="bottom"  height="360"> 
                                                <table border=0 cellpadding="0"  >
                                                    <tr>
                                                                 ...
                                                                 <td align="center" width="36">
                                                                          <table border=0 cellpadding="0"  >    
                                                                                         <tr><td height=20 align="center" width=36 valign="bottom"><div id="DivAnswerAgentNum">0</div></td></tr><td valign="bottom" id="AnswerAgentNumH"  height="1" background="<?php echo $this->_tpl_vars['system_config']['img_url']; ?>
/monitor/images/BG2.gif"></td></tr>
                                                                                 </table>
                                            ...
                                            <td  valign="bottom"  height="360"> 
                                                <table border=0 cellpadding="0" >
                                                    <tr> 
                                                                 ...
                                                                 <td align="center" width="36">
                                                                          <table border=0 cellpadding="0"  >    
                                                                                         <tr><td height=20 align="center" width=36 valign="bottom"><div id="DivIdleAgentNum">0</div></td></tr><td valign="bottom" id="IdleAgentNumH"  height="1" background="<?php echo $this->_tpl_vars['system_config']['img_url']; ?>
/monitor/images/BG3.gif"></td></tr>
                                                                                 </table>
                                            ...
                                            <td  valign="bottom"  height="360"> 
                                                <table border=0 cellpadding="0" >
                                                    <tr> 
                                                                 ...
                                                                 <td align="center" width="36">
                                                                          <table border=0 cellpadding="0"  >    
                                                                                         <tr><td height=20 align="center" width=36 valign="bottom"><div id="DivOtherAgentNum">0</div></td></tr><td valign="bottom" id="OtherAgentNumH"  height="1" background="<?php echo $this->_tpl_vars['system_config']['img_url']; ?>
/monitor/images/BG4.gif"></td></tr>
                                                                                 </table>
                                            ...
                                            <td  valign="bottom"  height="360"> 
                                                <table border=0 cellpadding="0" >
                                                    <tr> 
                                                                 ...
                                                                 <td align="center" width="36">
                                                                          <table border=0 cellpadding="0"  >    
                                                                                         <tr><td height=20 align="center" width=36 valign="bottom"><div id="DivAfterWorkAgentNum">0</div></td></tr><td valign="bottom" id="AfterWorkAgentNumH"  height="1" background="<?php echo $this->_tpl_vars['system_config']['img_url']; ?>
/monitor/images/BG5.gif"></td></tr>
                                                                                 </table>
                                            ...
                                            <td  valign="bottom"  height="360"> 
                                                <table border=0 cellpadding="0" >
                                                    <tr> 
                                                                 ...
                                                                 <td align="center" width="36">
                                                                          <table border=0 cellpadding="0"  >    
                                                                                         <tr><td height=20 align="center" width=36 valign="bottom"><div id="DivReqTransAgentNum">0</div></td></tr><td valign="bottom" id="ReqTransAgentNumH"  height="1" background="<?php echo $this->_tpl_vars['system_config']['img_url']; ?>
/monitor/images/BG6.gif"></td></tr>
                                                                                 </table>
                                            ...
                                            <td  valign="bottom"  height="360"> 
                                                <table border=0 cellpadding="0" >
                                                    <tr> 
                                                                 ...
                                                                 <td align="center" width="36">
                                                                          <table border=0 cellpadding="0"  >    
                                                                                         <tr><td height=20 align="center" width=36 valign="bottom"><div id="DivQueueSuccNum">0</div></td></tr><td valign="bottom" id="QueueSuccNumH" height="1" background="<?php echo $this->_tpl_vars['system_config']['img_url']; ?>
/monitor/images/BG7.gif"></td></tr>
                                                                                 </table>
                                            ...
                                            <td  valign="bottom"  height="360"> 
                                                <table border=0 cellpadding="0" >
                                                    <tr> 
                                                                 ...
                                                                 <td align="center" width="36">
                                                                          <table border=0 cellpadding="0"  >    
                                                                                         <tr><td height=20 align="center" width=36 valign="bottom"><div id="DivQueueFailNum">0</div></td></tr><td valign="bottom" id="QueueFailNumH" height="1" background="<?php echo $this->_tpl_vars['system_config']['img_url']; ?>
/monitor/images/BG8.gif"></td></tr>
                                                                                 </table>
 ...
 <SCRIPT LANGUAGE=javascript>
  ...
  var AddressID=<?php echo $this->_tpl_vars['skill']; ?>
;
  <?php echo '
  ...
  function initial()
{
          ...
          pno='; ?>
<?php echo $this->_tpl_vars['pno2']; ?>
<?php echo ';/*parseInt(pno);*/  
