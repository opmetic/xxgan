<?php /* Smarty version 2.6.20, created on 2011-07-13 00:11:24
         compiled from renter/menulist.tpl */ ?>
...
<?php echo '/qnmenurenter/edit/id/" + id, true);
}
...
function confirmDle(id)
{
	...
	if (bln)
	{
		location.href = "'; ?>
<?php echo $this->_tpl_vars['system_config']['img_url']; ?>
<?php echo '/qnmenurenter/del/id/" + id;
	}
}
</script>
'; ?>
