<?php /* Smarty version 2.6.20, created on 2011-05-26 23:26:22
         compiled from renter/areacodeadd.tpl */ ?>
...
/qnareacoderenter/adddo">
    <div style="color: #FF0000;"><?php echo $this->_tpl_vars['post']['errmsg']; ?>
</div>  
	<table cellpadding="10" cellspacing="10">
		<tr>
			<td align="right" width="100" >省:</td>
			<td><input class="easyui-validatebox" type="text" name="areacode_province" id="areacode_province" required="true" width="200"></input></td>
			<td></td>
		</tr>
		<tr>
			<td align="right">市:</td>
			<td><input class="easyui-validatebox" type="text" id="areacode_city" name="areacode_city" value=""></input></td>
			<td></td>
		</tr>
        <tr>
            <td align="right">区号:</td>
            <td><input class="easyui-validatebox" type="text" id="areacode" name="areacode" value=""></input></td>
            <td></td>
        </tr>
        <tr>
            <td align="right">接入号:</td>
            <td><input class="easyui-validatebox" type="text" id="areacode_phonenum" name="areacode_phonenum" value=""></input></td>
            <td></td>
        </tr>
        <tr>
            <td align="right">酒店/机票:</td>
            <td>
                <select name="areacode_group" id="areacode_group">
        ...
        <tr>
            <td align="right">类:</td>
            <td><input class="easyui-validatebox" type="text" id="areacode_class" name="areacode_class" value=""></input></td>
            <td></td>
        </tr>
		<tr>
			<td align="right"> </td>
