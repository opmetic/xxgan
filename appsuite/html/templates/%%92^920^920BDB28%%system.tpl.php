<?php /* Smarty version 2.6.20, created on 2011-09-16 10:12:43
         compiled from renter/system.tpl */ ?>
...
<?php echo '/scriptrenter/list", true);
            ...
            else if (node.text == "快捷键一")
            {
                updateWindows("快捷键一", "'; ?>
<?php echo $this->_tpl_vars['system_config']['img_url']; ?>
<?php echo '/qnbuttonrenter/lista", true);
            }
            else if (node.text == "快捷键二")
            {
                updateWindows("快捷键二", "'; ?>
<?php echo $this->_tpl_vars['system_config']['img_url']; ?>
<?php echo '/qnbuttonexrenter/lista", true);
            }
            else if (node.text == "查看区号")
            {
                updateWindows("查看区号", "'; ?>
<?php echo $this->_tpl_vars['system_config']['img_url']; ?>
<?php echo '/qnareacoderenter/list", true);
            }
		}
	});
