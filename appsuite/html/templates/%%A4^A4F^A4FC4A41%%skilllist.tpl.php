<?php /* Smarty version 2.6.20, created on 2011-07-18 15:42:21
         compiled from renter/skilllist.tpl */ ?>
...
<?php echo '/qnskillrenter/edit/id/" + id, true);
}
...
function confirmDle(id)
{
	...
	if (bln)
	{
		location.href = "'; ?>
<?php echo $this->_tpl_vars['system_config']['img_url']; ?>
<?php echo '/qnskillrenter/del/id/" + id;
	}
}
</script>
'; ?>
...
?>
		<tr>
            ...
            <td><?php echo $this->_tpl_vars['item']['fakecalling']; ?>
</td>
