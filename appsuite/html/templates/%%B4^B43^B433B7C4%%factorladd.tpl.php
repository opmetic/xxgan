<?php /* Smarty version 2.6.20, created on 2011-03-23 03:30:23
         compiled from factorladd.tpl */ ?>
...
/qnfactory/adddo">
	...
	<table cellpadding="10" cellspacing="10">
		<tr>
			...
			<td><input class="easyui-validatebox" type="text" name="name" id="name" required="true" width="200" value="<?php echo $this->_tpl_vars['post']['name']; ?>
"></input></td>
		...
		<tr>
			...
			<td><input class="easyui-validatebox" type="text" name="code"  value="<?php echo $this->_tpl_vars['post']['code']; ?>
"></input></td>
			<td> 平台提供 </td>
		</tr>
        <!--
		<tr>
			...
			<td><input class="easyui-validatebox" type="text" name="pwd"  value="<?php echo $this->_tpl_vars['post']['pwd']; ?>
"></input></td>
			<td> </td>
		</tr>
        -->
