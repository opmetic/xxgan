<?php /* Smarty version 2.6.20, created on 2010-12-27 05:33:06
         compiled from skilledit.tpl */ ?>
...
/qnskill/edit">
	<input type="hidden" name="id" value="<?php echo $this->_tpl_vars['skillData']['skill_id']; ?>
"/>
	<table cellpadding="10" cellspacing="10">
		<tr>
			<td align="right" width="100" >技能编号:</td>
			<td><input class="easyui-validatebox" type="text" name="skillcode" id="skillcode" required="true" width="200" value="<?php echo $this->_tpl_vars['skillData']['skill_code']; ?>
"></input></td>
			<td><span style="color:#FF0000;">*</span></td>
		</tr>
		<tr>
			<td align="right">技能名:</td>
			<td><input class="easyui-validatebox" type="text" name="skillname" id="skillname" value="<?php echo $this->_tpl_vars['skillData']['skill_name']; ?>
"></input></td>
			<td><span style="color:#FF0000;">*</span></td>
...
" <?php if ($this->_tpl_vars['skillData']['factory_id'] == $this->_tpl_vars['item']['factory_id']): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['item']['factory_name']; ?>
</option>
