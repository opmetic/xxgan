<?php /* Smarty version 2.6.20, created on 2011-09-16 10:15:21
         compiled from renter/buttonexlista.tpl */ ?>
...
<?php echo $this->_tpl_vars['system_config']['site_url']; ?>
<?php echo '/qnbuttonexrenter/add/", true);
}
...
<?php echo $this->_tpl_vars['system_config']['site_url']; ?>
<?php echo '/qnbuttonexrenter/edit/id/" + id, true);
}
...
function confirmDle(id)
{
	...
	if (bln)
	{
		location.href = "'; ?>
<?php echo $this->_tpl_vars['system_config']['site_url']; ?>
<?php echo '/qnbuttonexrenter/del/id/" + id;
	}
}
</script>
'; ?>
