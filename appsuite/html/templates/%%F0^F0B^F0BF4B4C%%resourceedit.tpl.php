<?php /* Smarty version 2.6.20, created on 2010-12-29 11:12:06
         compiled from resourceedit.tpl */ ?>
...
/qnresource/edit">
    <input type="hidden" name="id" value="<?php echo $this->_tpl_vars['resourceData']['resource_id']; ?>
" />
	...
	<table cellpadding="10" cellspacing="10">
		<tr>
			...
			<td><input class="easyui-validatebox" type="text" name="resource_name" id="resource_name" required="true" width="200" value="<?php echo $this->_tpl_vars['resourceData']['resource_name']; ?>
"></input></td>
...
" <?php if ($this->_tpl_vars['resourceData']['factory_id'] == $this->_tpl_vars['item']['factory_id']): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['item']['factory_name']; ?>
</option>
...
" <?php if ($this->_tpl_vars['resourceData']['resource_type'] == $this->_tpl_vars['item2']): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['item2']; ?>
</option>
                    <?php endforeach; endif; unset($_from); ?>
                </select>
            </td>
        ...
        <tr>
            ...
            <td><input type="text" name="resource_dsc" id="resource_dsc" required="true" width="500" value="<?php echo $this->_tpl_vars['resourceData']['resource_dsc']; ?>
"></input></td>
            <td></td>
        </tr>
		<tr>
